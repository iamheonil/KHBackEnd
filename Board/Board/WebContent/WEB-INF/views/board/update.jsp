...
<tr><td class="info">게시글번호</td><td>${viewBoard.boardno }</td></tr>
...
<tr><td colspan="2"><textarea id="content" name="content">${viewBoard.content }</textarea></td></tr>
</table>

첨부파일 <input type="file" name="file" value=""/> ${boardFile.storedname }
